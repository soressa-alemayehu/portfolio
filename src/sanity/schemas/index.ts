...
export const projectsType = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'longDescription', title: 'Detailed Case Study', type: 'text' }),
    defineField({ name: 'category', title: 'Category (e.g. Web, AI, Open Source)', type: 'string' }),
    defineField({
      name: 'techStack',
    ...
    defineField({ name: 'image', title: 'Project Preview Image', type: 'image' }),
    defineField({
      name: 'metrics',
